...
class SeqLSTM(nn.Module):
    def __init__(self, input_size, hidden_size, num_layers):
        ...
        # need input shape is [c, seq_len(f), size(hxw)]
...
class ChannelLSTM(nn.Module):
    def __init__(self, input_size, hidden_size, num_layers):
        ...
        # need input shape is [f, seq_len(c), size(hxw)]
        self.lstm = LSTM(input_size, hidden_size, num_layers)
...
class VSSM(nn.Module):
    def __init__(self, Frames, patch_size=4, in_chans=4, num_classes=3, depths=[2, 2, 9, 2],
        ...
        for i_layer in range(self.num_layers):
            ...
            if i_layer <= 2:
                if i_layer <2:
                    ...
                    size = 5
                lstm_s1 = SeqLSTM(input_size=size * size, hidden_size=15, num_layers=4)
                lstm_s2 = SeqLSTM(input_size=size * size, hidden_size=15, num_layers=4)
                ...
                lstm_c1 = ChannelLSTM(input_size=size * size, hidden_size=int((dims[0] * 2 ** i_layer)/2), num_layers=2)
                lstm_c2 = ChannelLSTM(input_size=size * size, hidden_size=int((dims[0] * 2 ** i_layer)/4), num_layers=2)
                ...
                lstm_s1 = SeqLSTM(input_size=5*5, hidden_size=15, num_layers=4)
                lstm_s2 = SeqLSTM(input_size=5 * 5, hidden_size=15, num_layers=4)
                ...
                lstm_c2 = ChannelLSTM(input_size=5 * 5, hidden_size=int(768/2), num_layers=2)
        ...
        self.seq_lstm = SeqLSTM(input_size=5*5, hidden_size=15, num_layers=4)
        self.channel_lstm = ChannelLSTM(input_size=5*5, hidden_size=768, num_layers=2)
